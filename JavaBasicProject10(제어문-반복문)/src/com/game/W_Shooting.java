...
class W_Shooting_frame extends Frame implements KeyListener, Runnable
{
	...
	public void Init_GAME(){
		...
		gamescreen.item[2]=makeImage("c:\\rsc\\game\\item2.png");//아이템 추가
		...
		gamescreen.enemy[1]=makeImage("c:\\rsc\\game\\enemy1.png");//보스 추가
		gamescreen.enemy[2]=makeImage("c:\\rsc\\game\\enemy2.png");//위치 네우로이
